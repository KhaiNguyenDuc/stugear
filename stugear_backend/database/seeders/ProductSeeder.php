...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Bài giảng vật lý đại cương',
                'price' => 30000,
                'description' => 'Tài liệu tổng hợp bài giảng và bài tập vật lý đại cương từ cơ bản đến nâng cao.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(25000, 35000),
                'quantity' => rand(1, 10),
                'status' => 3,
                'user_id' => rand(1, 8),
                'category_id' => 2,
            ...
            [
                'name' => 'Tài liệu cơ học cơ sở',
                'price' => 32000,
                'description' => 'Tài liệu về các nguyên lý cơ bản của cơ học, bao gồm các ví dụ và bài tập.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(30000, 40000),
                'quantity' => rand(1, 10),
                'status' => 3,
                'user_id' => rand(1, 8),
                'category_id' => 2,
            ...
            [
                'name' => 'Tài liệu học toán cao cấp',
                'price' => 28000,
                'description' => 'Tài liệu chuyên sâu về các khái niệm và bài tập toán cao cấp.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(25000, 35000),
            ...
            [
                'name' => 'Tài liệu lịch sử Việt Nam cận đại',
                'price' => 32000,
                'description' => 'Tài liệu chi tiết về lịch sử Việt Nam từ thế kỷ 19 đến nay.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(30000, 40000),
            ...
            [
                'name' => 'Tài liệu học tiếng Anh giao tiếp',
                'price' => 27000,
                'description' => 'Tài liệu học tiếng Anh giao tiếp cơ bản và nâng cao cho người mới bắt đầu.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(25000, 30000),
                'quantity' => rand(1, 10),
                'status' => 3,
                'user_id' => rand(1, 8),
                'category_id' => 2,
            ...
            [
                'name' => 'Tài liệu học tập văn học Việt Nam',
                'price' => 28000,
                'description' => 'Tài liệu tổng hợp các tác phẩm văn học nổi tiếng của Việt Nam từ cổ điển đến hiện đại.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(25000, 35000),
            ...
            [
                'name' => 'Tài liệu học tập phương pháp nghiên cứu khoa học',
                'price' => 29000,
                'description' => 'Tài liệu hướng dẫn cách thức nghiên cứu khoa học, từ lựa chọn đề tài đến phương pháp tiến hành.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(25000, 35000),
            ...
            [
                'name' => 'Tài liệu học tập luật tố tụng dân sự',
                'price' => 33000,
                'description' => 'Tài liệu hướng dẫn về pháp luật dân sự, bao gồm các vấn đề pháp lý cơ bản và áp dụng.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(30000, 40000),
            ...
            [
                'name' => 'Tài liệu học tập khoa học lãnh đạo',
                'price' => 31000,
                'description' => 'Tài liệu học tập các kỹ năng lãnh đạo hiệu quả trong tổ chức và doanh nghiệp.',
                'brand' => 'HCMUTE', // Fixed brand data
                'condition' => rand(1, 2),
                'edition' => 'ver_' . rand(0, 9) . '.' . rand(0, 9) . '.' . rand(0, 9),
                'origin_price' => rand(30000, 35000),
                'quantity' => rand(1, 10),
                'status' => 3,
                'user_id' => rand(1, 8),
                'category_id' => 2,
